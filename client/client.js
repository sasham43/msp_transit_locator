  ...
  vm.getVehicleLocations = function(){
    ...
    $http.get('http://svc.metrotransit.org/NexTrip/VehicleLocations/' + vm.routeOptions.selectedOption.id).then(function(response){
      ...
      vm.responseList.map(function(object){
        ...
        if (vm.routeOptions.selectedOption.id == 901 || vm.routeOptions.selectedOption.id == 902 || vm.routeOptions.selectedOption.id == 903 || vm.routeOptions.selectedOption.id == 888){
